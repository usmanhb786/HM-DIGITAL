...
const FloatingWhatsApp: React.FC = () => {
  return (
    ...
    >
      <div className="absolute right-full mr-4 bg-white text-slate-800 px-4 py-2 rounded-lg text-sm font-semibold shadow-xl opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap hidden md:block">
